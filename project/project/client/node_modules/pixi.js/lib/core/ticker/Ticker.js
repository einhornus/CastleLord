...
var Ticker = function () {
    ...
    function Ticker() {
         ...
         * Also separating frame message from update method
    ...
    /**
     * Conditionally message a new animation frame.
    ...
    Ticker.prototype.update = function update() {
        ...
        // _requestIfNeeded is invoked, then the callback for the animation frame the ticker message,
